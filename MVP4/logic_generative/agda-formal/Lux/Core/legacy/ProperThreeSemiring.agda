...
-- STATUS: Active - Proper three-semiring architecture
...
module Lux.Core.ProperThreeSemiring where
...
-- ============================================================================
-- MODULI-REGULARISED GAUGE (AS SPECIFIED IN V2)
-- ============================================================================

record ModuliRegularisedGauge (carriers : TrialityCarriers) (bulk-semiring : BulkSemiring carriers) : Set₁ where
  open TrialityCarriers carriers
  open BulkSemiring bulk-semiring
...
record TrialityStructure : Set₁ where
  field
    ...
    normalization : ModuliRegularisedGauge carriers bulk-semiring
