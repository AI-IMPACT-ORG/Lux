...
-- STATUS: Active - Minimal onion-style hexagonal architecture
...
-- 2. TRIALITY LAYER: Core constructive logic
...
module Lux.Architecture.MinimalOnionHexagon where
...
-- Triality operations (Core requirement)
...
-- Triality functors (Core requirement)
...
-- Auxiliary transporter (Class requirement)
...
-- Feynman/Sum-over-Histories (Class requirement)
...
-- Truth theorems (Class requirement)
