...
-- STATUS: Active - Minimal working example
-- DEPENDENCIES: Lux.Core.Minimal

{-# OPTIONS --cubical --without-K #-}

module Lux.Main.MinimalWorkingExample where
...
-- ============================================================================
-- MINIMAL WORKING Lux SYSTEM
-- ============================================================================

-- Minimal working Lux system using the compilable foundation
record MinimalWorkingLuxSystem : Set₁ where
  field
...
-- ============================================================================
-- MINIMAL WORKING SYSTEM INITIALIZATION
-- ============================================================================

-- Initialize minimal working Lux system
initialize-minimal-working-system : MinimalWorkingLuxSystem
initialize-minimal-working-system = record
  { triality = record
...
-- ============================================================================
-- MINIMAL WORKING SYSTEM SUMMARY
-- ============================================================================

-- The minimal working Lux system provides:
...
-- This minimal working system provides:
