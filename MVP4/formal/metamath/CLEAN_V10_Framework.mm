...
ax-gen-phase $a |- nfPhase ( normalForm ( generatingFunctional obsGen sourceList01 ) ) = 1 $.
ax-gen-scale $a |- nfScale ( normalForm ( generatingFunctional obsGen sourceList01 ) ) = 2 $.
ax-moduli-phase $a |- nfPhase ( applyHeaderFlow moduliExample bulkTerm ) = 4 $.
