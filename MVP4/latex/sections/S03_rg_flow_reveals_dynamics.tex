...
Fix a class $\mathcal{A}$ of admissible observables closed under encoders and RG flow. A computational system exhibits different behaviors under RG flow as the scale parameter $\Lambda$ varies:
\begin{align}
