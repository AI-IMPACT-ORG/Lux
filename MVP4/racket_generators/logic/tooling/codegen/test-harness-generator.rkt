...
(define (generate-coq-core-tests config)
  (string-join
   (list
    ...
    "Require Import generated_Core."
    "Require Import generated_Observers."
    "Require Import generated_Kernels."
    "Require Import generated_NormalForms."
    ""
...
(define (generate-lean-core-tests config)
  (string-join
   (list
    ...
    "import lib.generated_Kernels"
    "import lib.generated_NormalForms"
    ""
    "-- CLEAN v10 Core Mathematical Tests"
    ""
    "namespace CoreTests"
    ""
    "-- Test 1: Header Mathematics"
    "def test_header_addition : Header :="
    "  header_add (header 1.0 2.0) (header 3.0 4.0)"
    ""
    "theorem test_header_addition_correct : test_header_addition = header 4.0 6.0 :="
    "  rfl"
    ""
    "def test_header_multiplication : Header :="
    "  header_multiply (header 1.0 2.0) (header 3.0 4.0)"
    ""
    "theorem test_header_multiplication_correct : test_header_multiplication = header 3.0 8.0 :="
    "  rfl"
    ""
    "-- Test 2: Observer Functions"
    "def test_observer_value : Term → Term :="
    "  observer_value"
    ""
    "-- Test 3: Property-Based Testing"
    "theorem test_header_commutativity : ∀ h1 h2 : Header, header_add h1 h2 = header_add h2 h1 :="
    "  λ h1 h2 => rfl"
    ""
    "theorem test_header_associativity : ∀ h1 h2 h3 : Header, header_add (header_add h1 h2) h3 = header_add h1 (header_add h2 h3) :="
    "  λ h1 h2 h3 => rfl"
    ""
    "end CoreTests")
   "\n"))
...
(define (generate-isabelle-core-tests config)
  (string-join
   (list
    ...
    "imports Main"
    "  \"lib.generated-Core\""
    "  \"lib.generated-Observers\""
    "  \"lib.generated-Kernels\""
    "  \"lib.generated-NormalForms\""
    "begin"
    ""
    "(* CLEAN v10 Core Mathematical Tests *)"
    ""
    "(* Test 1: Header Mathematics *)"
    "definition test_header_addition :: \"Header\" where"
    "\"test_header_addition = header_add (header 1.0 2.0) (header 3.0 4.0)\""
    ""
    "lemma test_header_addition_correct: \"test_header_addition = header 4.0 6.0\""
    "  by (simp add: test_header_addition_def)"
    ""
    "definition test_header_multiplication :: \"Header\" where"
    "\"test_header_multiplication = header_multiply (header 1.0 2.0) (header 3.0 4.0)\""
    ""
    "lemma test_header_multiplication_correct: \"test_header_multiplication = header 3.0 8.0\""
    "  by (simp add: test_header_multiplication_def)"
    ""
    "(* Test 2: Observer Functions *)"
    "definition test_observer_value :: \"Term ⇒ Term\" where"
    "\"test_observer_value = observer_value\""
    ""
    "(* Test 3: Property-Based Testing *)"
    "lemma test_header_commutativity: \"header_add h1 h2 = header_add h2 h1\""
    "  by simp"
    ""
    "lemma test_header_associativity: \"header_add (header_add h1 h2) h3 = header_add h1 (header_add h2 h3)\""
    "  by simp"
    ""
    "end")
   "\n"))
...
(define (generate-agda-property-tests config)
  (string-join
   (list
    "module tests.PropertyTests where"
    ""
    "open import lib.generated-Core"
    "open import Agda.Builtin.Equality"
    ""
