...
;; Simple Metamath Generator with Lessons Learned
;; Implements proper class vs set distinction for global vs local truth
;; Generates correct Metamath syntax with unique labels
...
(define (generate-metamath-foundation)
  (string-append
   ...
   "$( Type declarations - unique labels $)\n"
   "wcel-A $f wff A e. C $.\n"
   "wcel-B $f wff B e. C $.\n"
   "wcel-D $f wff D e. C $.\n"
   "wcel-E $f wff E e. C $.\n"
...
(define (generate-metamath-testsuite)
  (string-append
   ...
   "  wcel-A wcel-B GlobalLocalCorrespondence-def $.\n\n"
