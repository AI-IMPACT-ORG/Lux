...
-- Default NFAPI built from ExpLogStructure
make-nf-api : (core : CoreKernelStructure) → NFAPI core
make-nf-api core = record
  { NF = λ t → ((pos zero , pos zero) , CoreSemiring.oneCore (CoreKernelStructure.core-semiring core))
  ; NF^B = λ t → t
