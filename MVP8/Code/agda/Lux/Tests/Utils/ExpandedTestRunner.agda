...
-- STATUS: Active - Comprehensive test runner with Lux Core, Lux Ops, and Truth Theorems
...
-- - Lux Core tests (Triality Operations, Moduli System)
-- - Lux Ops tests (Guarded Negation, Domain Ports)
...
-- Lux Axioms Foundation Tests
open import Lux.Tests.Foundation.Axioms.EnhancedA0Semirings
open import Lux.Tests.Foundation.Axioms.EnhancedA1CentralScalars
open import Lux.Tests.Foundation.Axioms.EnhancedA2Observers
open import Lux.Tests.Foundation.Axioms.EnhancedA3CrossCentrality
open import Lux.Tests.Foundation.Axioms.EnhancedA4Connective
open import Lux.Tests.Foundation.Axioms.EnhancedA5Braiding
open import Lux.Tests.Foundation.Axioms.EnhancedA6ExpLog
open import Lux.Tests.Foundation.Axioms.EnhancedA7Basepoint

-- Lux Core Tests
open import Lux.Tests.Core.TrialityOperations
open import Lux.Tests.Core.ModuliSystem

-- Lux Ops Tests
open import Lux.Tests.Class.GuardedNegation
open import Lux.Tests.Class.DomainPorts
...
expanded-test-suites core-kernel =
  ...
  -- Lux Core Tests
  lux-core-triality-test-suite core-kernel ∷
  lux-core-moduli-system-test-suite core-kernel ∷
  -- Lux Ops Tests
  lux-ops-guarded-negation-test-suite core-kernel ∷
  lux-ops-domain-ports-test-suite core-kernel ∷
  -- Truth Theorems Tests
