...
(define header-only-normal-form (normal-form-strategy 'header-only (λ (t)
  ...
  (b-with-grade-if-known (rec-z-zbar (first d) (second d) (third d) (fourth d)) g)) '()))
...
(define lexicographic-tropical-normal-form (normal-form-strategy 'lexicographic-tropical (λ (t)
  ...
  (b-with-grade-if-known (rec-z-zbar (first H) (second H) (third H) (fourth d)) g)) '()))
...
(define (NF-parametric μ θ b)
  ...
  (b-with-grade-if-known (rec-z-zbar fθ gμz gμzb (fourth d)) g))
...
(define (NF-parametric-multi flows b)
  ...
  (b-with-grade-if-known (rec-z-zbar k mz mzb (fourth d)) g))
...
(define (run-moduli-system-tests)
  (displayln "=== Lux Ops Moduli System Tests (Lux) ===")
